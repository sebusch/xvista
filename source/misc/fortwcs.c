...
ADDRESS	nc;		/* Number of characters in hstring (supplied by Fortran */
{
    int id;
...
ADDRESS	np;		/* Length of projection (supplied by Fortran) */
...
double	*epoch;		/* Epoch of coordinates, used for FK4/FK5 conversion
			 * no effect if 0 */
ADDRESS	nc1, nc2;	/* Lengths of CTYPEs (supplied by Fortran) */
...
ADDRESS	nc;		/* Length of coorsys (set by Fortran) */
...
ADDRESS	lstr;		/* Length of world coordinate string (set by Fortran) */
